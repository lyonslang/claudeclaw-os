...
export function updateAgentSystemPrompt(next) {
...
export const AGENT_TIMEOUT_MS = parseInt(process.env.AGENT_TIMEOUT_MS || envConfig.AGENT_TIMEOUT_MS || '900000', 10);
...
export const TIER_T1_MODEL = process.env.TIER_T1_MODEL || envConfig.TIER_T1_MODEL || 'claude-haiku-4-5';
export const TIER_T2_MODEL = process.env.TIER_T2_MODEL || envConfig.TIER_T2_MODEL || 'claude-haiku-4-5';
export const TIER_T3_MODEL = process.env.TIER_T3_MODEL || envConfig.TIER_T3_MODEL || 'claude-sonnet-4-6';
export const TIER_T4_MODEL = process.env.TIER_T4_MODEL || envConfig.TIER_T4_MODEL || 'claude-sonnet-4-6';
